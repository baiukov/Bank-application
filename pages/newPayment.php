...
<body>
    <main class='container'>
        ...
        <form class='blue-box' id='payment' method='POST' action='../pages/newPayment.php'>
            <h2>New payment</h2>
            ...
            <div class='input-field' name='type'>
                ...
                <select class='input' style='color: white;' name='sender'>
                    ...
                    ?>
                        <option <?php echo $_GET['id'] == $accountID ? 'selected' : ''; ?>><?php echo $account['account_id']; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class='input-field'>
            ...
            <div class='input-field' name='type'>
                ...
                <select class='input' style='color: white;' name='reason'>
                    <?php foreach ($categories as $category) : ?>
                        <option 
                            <?php echo isset($_POST['reason']) && $_POST['reason'] == $category['name'] ? 'selected' : ''; ?> 
